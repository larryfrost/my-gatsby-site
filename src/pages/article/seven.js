...
const ArticlePage = ({ data }) => {
  ...
  const filteredArticle = articles.find(article => article.title === "Skip the spirits with delicious mocktails"); 
  ...
  return(
    <Layout>
      ...
      <StaticImage
        alt="mojito-mocktail"
        src="http://csc496f24demo.tldr.dev/sites/default/files/mojito-mocktail.jpg"
      />
      </div>
