...
const RecipePage = ({ data }) => {
  ...
  const filteredRecipe = recipes.find(recipe => recipe.title === "Victoria sponge cake");

  return (
    <Layout>
    <div> 
      <StaticImage
        alt="victoria-sponge-umami"
        src="http://csc496f24demo.tldr.dev/sites/default/files/victoria-sponge-umami.jpg"
      />
      </div>
