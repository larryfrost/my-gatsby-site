...
const RecipePage = ({ data }) => {
  ...
  const filteredRecipe = recipes.find(recipe => recipe.title === "Watercress soup");

  return (
    <Layout>
    <StaticImage
        alt="watercress-soup-umami"
        src="http://csc496f24demo.tldr.dev/sites/default/files/watercress-soup-umami.jpg"
      />
