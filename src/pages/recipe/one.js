...
const RecipePage = ({ data }) => {
  ...
  const filteredRecipe = recipes.find(recipe => recipe.title === "SUUPRDEEP mediterranean quiche");

  return (
    <Layout>
    <div> 
      <StaticImage
        alt="mediterranean-quiche-umami"
        src="http://csc496f24demo.tldr.dev/sites/default/files/mediterranean-quiche-umami.jpg"
      />
      </div>
