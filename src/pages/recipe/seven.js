...
const RecipePage = ({ data }) => {
  ...
  const filteredRecipe = recipes.find(recipe => recipe.title === "Thai green curry");

  return (
    <Layout>
    <div> 
      <StaticImage
        alt="thai-green-curry-umami"
        src="http://csc496f24demo.tldr.dev/sites/default/files/thai-green-curry-umami.jpg"
      />
      </div>
