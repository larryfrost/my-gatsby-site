...
const RecipePage = ({ data }) => {
  ...
  const filteredRecipe = recipes.find(recipe => recipe.title === "Vegan chocolate and nut brownies");

  return (
    <Layout>
    <div> 
      <StaticImage
        alt="vegan-chocolate-nut-brownies"
        src="http://csc496f24demo.tldr.dev/sites/default/files/vegan-chocolate-nut-brownies.jpg"
      />
      </div>
